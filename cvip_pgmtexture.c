...
void results (  float *Tp,	char *c,	float *a),  mkbalanced (float **a,int n), reduction (float **a,int n), simplesrt (int n,float arr[]);
int hessenberg ( float **a, int n,float  *wr, float  *wi);
float f1_asm (float **p,int Ng), f2_contrast (float **p,int Ng), f3_corr (float **p,int Ng), f4_var (float **p,int Ng), f5_idm (float **p,int Ng),
	f6_savg (float **p,int Ng), f7_svar (float **p,float S,int Ng), f8_sentropy (float **p,int Ng), f9_entropy (float **p,int Ng), f10_dvar (float **p,int Ng),
	f11_dentropy (float **p,int Ng), f12_icorr (float **p,int Ng), f13_icorr (float **p,int Ng), f14_maxcorr (float **p,int Ng);
 float  *pgm_vector (int nl,int nh ), **pgm_matrix (int,int,int,int);
...
int hessenberg (
  float **a, int n,float  *wr, float  *wi
  )
